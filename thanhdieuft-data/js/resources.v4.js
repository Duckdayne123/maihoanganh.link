...
<div class="ThanhDieuMain">
  <img class="Avatar" src="//graph.facebook.com/100060406073771/picture?width=100&height=100&access_token=6628568379|c1e620fa708a1d5696fb991c1bde5662" width="120" height="120" alt="MaiHoangAnh">
  <h2 class="HoVaTen__">
  <div id="userName">Mai Hoàng Anh
...
<div class="ThongTinThanhToan">
    <p class="ThongTinThanhToanTitle">— MB Bank —</p>
    <p class="ThongTinThanhToanText">=> STK: 5546602188888 <=<br>=> CTK: MAI HOANG ANH <=</p>
    </div>
    <div class="XuongDong__">&nbsp;</div>
<div class="ThongTinThanhToan">
    <p class="ThongTinThanhToanTitle">— Momo Payment —</p>
    <p class="ThongTinThanhToanText">=> STK: 0934062236 <=<br>=> CTK: MAI HOANG ANH <=</</p>
    </div>
<hr class="ThanhGachNgang">
<div class="XuongDong__">&nbsp;</div>
<div class="XuongDong__">&nbsp;</div>
...
<p class="ThanhDieuFtCopyright">
  <span class="copyright">Created by
    <a href="//facebook.com/100060406073771" style="text-decoration: none;"><u style="color: aliceblue;">HoangAnh ♡</u></a><br>
    <strong>All rights reserved - © 2023</strong></span>
</p>
</footer>
<div id="Toast">Resources Code Vip</div>
`;
...
(function() {
  ...
  function ThanhDieuProtect() {
    ...
    if (thanhdieutv === null) {
      alert("Vui lòng không chỉnh sửa tên tác giả, mã lỗi 0x000002 @DuckNha");
...
// CHECK DOMAIN VERIFY
(function () {
  const MienChinh__ = ["api.thanhdieu.com","thanhdieu.com","admln.vn","localhost", "maihoanganh.link"];
...
// CHECK NAME OWNER
var __Owner__ = ["Mai Hoàng Anh"];
var __LinkThanhDieu__ = ["https://MAIHOANGANH.LINK"];
var __OwnerFound__ = false;
var __DomainOwner__ = "MAIHOANGANH.LINK";
...
const ThanhDieu_List = [
  "./thanhdieuft-data/img/a.mp3",
  "./thanhdieuft-data/img/b.mp3", 
  "./thanhdieuft-data/img/c.mp3",
  "./thanhdieuft-data/img/d.mp3",
  "./thanhdieuft-data/img/e.mp3",
...
strings: ["Hi my name is HoangAnh","Hey brother, I'm a Developer.", "I like website design =]]"],
typeSpeed: 95,
backSpeed: 75,
loop: true
})
...
function ThanhDieuLinkSocial(link) {
  ...
  function Facebook() {
    ThanhDieuLinkSocial('https://www.facebook.com/100060406073771');
  }
  
  function Youtube() {
    ThanhDieuLinkSocial('https://www.youtube.com/@nhacchill2336');
  }
  
  function Instagram() {
    ThanhDieuLinkSocial('https://instagram.com/hoang_anhh2_00_7?igshid=MzMyNGUyNmU2YQ==');
  }
  // TOAST SHOW
  function ShowToast() {
